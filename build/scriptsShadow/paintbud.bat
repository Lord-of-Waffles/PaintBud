...
set CLASSPATH=%APP_HOME%\lib\paintbud-all.jar

@rem Execute paintbud
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PAINTBUD_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%PAINTBUD_EXIT_CONSOLE%" exit 1
exit /b 1
